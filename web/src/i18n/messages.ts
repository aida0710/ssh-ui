...
export const en = {
  ...
  "keys.manageStoredPassphrase": "Stored passphrase",
  "keys.storedPassphraseHeading": "Stored passphrase: {path}",
...
export const ja: Record<MessageKey, string> = {
  ...
  "keys.manageStoredPassphrase": "保存パスフレーズ",
  "keys.storedPassphraseHeading": "保存パスフレーズ: {path}",
  "keys.storedPassphraseNote":
