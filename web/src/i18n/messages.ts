...
export const en = {
  ...
  "update.restart": "Updated. Restart ssh-ui to run it.",
  "update.failed": "The update could not be applied.",
  ...
  "groups.settingHeading": "Add a setting to a group",
  "groups.group": "Group",
...
export const ja: Record<MessageKey, string> = {
  ...
  "update.available": "{version} が利用できます",
  "update.apply": "更新",
  "update.applying": "更新中…",
  "update.restart": "更新しました。ssh-ui を再起動すると反映されます。",
  ...
  "groups.add": "グループを追加",
  "groups.settingHeading": "グループに設定を追加する",
  "groups.group": "グループ",
