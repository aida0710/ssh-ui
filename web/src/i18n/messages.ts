...
export const en = {
  ...
  "explorer.newFileNote":
    "A new file is only read once an Include in ~/.ssh/config points at it. Add that line in the entry file below.",
...
export const ja: Record<MessageKey, string> = {
  ...
  "explorer.newFileNote":
    "新しいファイルは、~/.ssh/config の Include が指して初めて読まれます。下の起点ファイルにその行を追加してください。",
